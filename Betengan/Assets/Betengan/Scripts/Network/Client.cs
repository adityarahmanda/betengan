...
public class Client : MonoBehaviour
{
    ...
    private void InitializeClientData()
    {
        packetHandlers = new Dictionary<int, PacketHandler>()
        {
            ...
            { (int)ServerPackets.spawnPlayers, ClientHandle.SpawnPlayers },
            { (int)ServerPackets.startNewRound, ClientHandle.StartNewRound },
            ...
            { (int)ServerPackets.teamScore, ClientHandle.TeamScore },
            { (int)ServerPackets.roundWinner, ClientHandle.SetRoundWinner },
            { (int)ServerPackets.gameWinner, ClientHandle.SetGameWinner },
